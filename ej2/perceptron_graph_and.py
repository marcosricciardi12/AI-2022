...
def main():         
    ...
    pos_x = []
    error = 1
    print("Perceptron simple compuerta AND")
    print("\nPesos iniciales: \nw0 = %f \nw1 = %f \nw2 = %f "%(w0, w1, w2))
    input("\nPresione enter para continuar. Error menor a 0.01")
    count = 0
    a=0
    ...
    plt.title("Errores_and")
    plt.legend()
    plt.savefig("errores_and.png")
    plt.show()
    plt.close()
    plt.figure(figsize=(10,7))
